...
def generate_morph_sequence(duration,frame_rate,img1,img2,points1,points2,tri_list,size):
    ...
    for j in range(0, num_images):
        ...
        for i in range(len(tri_list)):
            ...
            cv2.line(morphed_frame, pt1, pt2, (64, 64, 64), 1, 4, 0)
            cv2.line(morphed_frame, pt2, pt3, (64, 64, 64), 1, 4, 0)
            cv2.line(morphed_frame, pt3, pt1, (64, 64, 64), 1, 4, 0)
